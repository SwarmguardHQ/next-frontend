        ...
        <div className="space-y-4">
          ...
          <Card className="flex flex-col">
            ...
            <Card className="flex flex-col border-t-4 border-t-destructive shadow-[4px_4px_0_0_rgb(127_29_29)]">
              ...
              <CardContent>
                <div className="max-h-54 space-y-2 overflow-y-auto pr-1 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-black/20 [&::-webkit-scrollbar-thumb]:bg-cyan-950/80 [&::-webkit-scrollbar-thumb]:rounded-none hover:[&::-webkit-scrollbar-thumb]:bg-cyan-900/80">
